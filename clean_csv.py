...
def cleanDataFrame(data_frame):
    ...
    cleaned_thrice['Start_Time'] = pd.to_datetime(cleaned_thrice['Start_Time'], format = 'mixed') # Temp fix, added format = 'mixed'
    cleaned_thrice['End_Time'] = pd.to_datetime(cleaned_thrice['End_Time'], format = 'mixed')
